...
/*#__PURE__*/
function () {
  function Mongoose(url, name, schema) {
    _classCallCheck(this, Mongoose);

    var realUrl = process.env[url];
    var db = null;

    if (!dbs[realUrl]) {
      dbs[realUrl] = _mongoose.default.createConnection(realUrl);
      db = dbs[realUrl];
    } else {
      db = dbs[realUrl];
    }
  ...
  _createClass(Mongoose, [{
    ...
    value: function () {
        ...
        return _regenerator.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                create = _args11.length > 1 && _args11[1] !== undefined ? _args11[1] : {};
                ret = {
                  _id: '',
                  create: false
                };
      ...
      return function findOrCreate(_x9) {
